...
const Knob = props => {
    ...
    return (
        <div className = "a-knob">
            <label className="a-knob-handle" htmlFor="knob"></label>
            <input 
                className="a-knob-input" 
                type="number" 
                id="knob" 
                name="knob" 
                min="0" max="1000" 
            ...
            <div className="a-knob-indicator"></div>
            <div className="a-knob-label"></div>
        </div>
    )
}
