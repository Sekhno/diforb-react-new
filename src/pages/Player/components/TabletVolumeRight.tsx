...
const OFFSETX = 75  
const OFFSETY = 59 
const STARTANGLE = Math.PI * 1.47 
const ENDANGLE = Math.PI * 1.76 
const DIFFANGLE = STARTANGLE - ENDANGLE
const TOP = 13, BOTTOM = 200
const STEP = DIFFANGLE / (BOTTOM - TOP)

export const TabletVolumeRight = (props: PropsSliderInterface) => {
  ...
  return(
    <svg x='0px' y='0px' width='105px' height='227px' viewBox='0 0 105 227' enableBackground='new 0 0 105 227' >
      ...
      <g className = { styles.volumeGrad } ref = { gradSVGRef } transform='translate(11,5)' clipPath='url(#VOLUME_RIGHT_RANGE_CLIP-PATH)'>
...
export default TabletVolumeRight