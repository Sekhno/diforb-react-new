...
export const TabletVolumeLeft = (props: PropsSliderInterface) => {
  ...
  const handlerMove = (event: Event) => {
    ...
    if (gradSVGRect && curY > gradSVGRect.top && curY <= gradSVGRect.bottom) {
      const value = (gradSVGRect.bottom - curY)
  ...
  return (
    <svg x='0px' y='0px' width='105px' height='227px' viewBox='0 0 105 227' enableBackground='new 0 0 105 227' >
      ...
      <g className = { styles.volumeGrad } ref = { gradSVGRef } transform='translate(19,12)' clipPath='url(#VOLUME_LEFT_CLIP_PATH)'>
        <g transform='translate(-1,0)'>
          <defs>
...
export default TabletVolumeLeft