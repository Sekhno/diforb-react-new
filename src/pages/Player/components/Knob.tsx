import React, { createRef, useEffect, useRef, memo, RefObject } from 'react'
import { SessionStorage, Side } from '../types'
import KnobInput from './KnobInputClass'
import './knob.scss'
...
const Knob = memo((props: any) => {
	...
	useEffect(() => {
		knobInput = new KnobInput(tensionKnob.current, {
			visualContext: function () {
				...
				let ringStyle: any = getComputedStyle(this.element.querySelector('.indicator-ring-bg'));
	...
	return (
		<div
			...
			ref = { tensionKnob as RefObject<HTMLDivElement> }
		>
